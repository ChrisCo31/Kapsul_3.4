...
class Media
{
    ...
    private $selectors;
    /**
     * @ORM\ManyToMany(targetEntity="CTS\KapsBundle\Entity\Theme", mappedBy="media", cascade={"all"})
     */
    private $themes;
    /**
     ...
     * Add theme
     *
     * @param \CTS\KapsBundle\Entity\Theme $theme
     *
     * @return Media
     */
    public function addTheme(\CTS\KapsBundle\Entity\Theme $theme)
    {
        $this->themes[] = $theme;
     ...
     * @param \CTS\KapsBundle\Entity\Theme $theme
     */
    public function removeTheme(\CTS\KapsBundle\Entity\Theme $theme)
    {
